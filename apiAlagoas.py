...
def consultar_processo():
    ...
    numero_processoAlagoas = request.json['numero_processoAlagoas']

    url1Grau = f'https://www2.tjal.jus.br/cpopg/show.do?&processo.foro=1&processo.numero={numero_processoAlagoas}'
    url2Grau = f'https://esaj.tjce.jus.br/cposg5/search.do?conversationId=&paginaConsulta=0&cbPesquisa=NUMPROC&numeroDigitoAnoUnificado=0624478-78.2023&foroNumeroUnificado=0000&dePesquisaNuUnificado={numero_processoAlagoas}&dePesquisaNuUnificado=UNIFICADO&dePesquisa=&tipoNuProcesso=UNIFICADO'
